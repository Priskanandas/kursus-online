...
<form action="{{ url('admin/kategori_kursus/tambah') }}" method="post" accept-charset="utf-8">
{{ csrf_field() }}

<div class="form-group row">
	<label class="col-md-3 text-right">Nama Kategori</label>
	<div class="col-md-9">
		<input type="text" name="nama_kategori_kursus" class="form-control" placeholder="Nama kategori kursus" value="" required>
		@if ($errors->has('nama_kategori_kursus'))
	      	<span class="text-danger">{{ $errors->first('nama_kategori_kursus') }}</span>
	    @endif  
	</div>
</div>
