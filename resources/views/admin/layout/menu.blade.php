        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Jadwal Kursus<i class="fas fa-angle-left right"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="{{ asset('admin/agenda') }}" class="nav-link"><i class="fas fa-newspaper nav-icon"></i><p>Data Jadwal &amp; Kursus</p></a>
              </li>
              <li class="nav-item"><a href="{{ asset('admin/agenda/tambah') }}" class="nav-link"><i class="fa fa-plus nav-icon"></i><p>Tambah Jadwal &amp; Kursus</p></a>
              </li>
              <li class="nav-item"><a href="{{ asset('admin/kategori_agenda') }}" class="nav-link"><i class="fa fa-tags nav-icon"></i><p>Kategori Kursus</p></a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Daftar Kursus<i class="fas fa-angle-left right"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="{{ asset('admin/murid') }}" class="nav-link"><i class="fas fa-newspaper nav-icon"></i><p>Data Murid</p></a>
              </li>
              <li class="nav-item"><a href="{{ asset('admin/murid/tambah') }}" class="nav-link"><i class="fa fa-plus nav-icon"></i><p>Daftar</p></a>
              </li>
              <li class="nav-item"><a href="{{ asset('admin/kategori_kursus') }}" class="nav-link"><i class="fa fa-tags nav-icon"></i><p>Mapel Kursus</p></a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Staff &amp; Mentor<i class="fas fa-angle-left right"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="{{ asset('admin/staff') }}" class="nav-link"><i class="fas fa-newspaper nav-icon"></i><p>Data Staff &amp; Mentor</p></a>
              </li>
              <li class="nav-item"><a href="{{ asset('admin/staff/tambah') }}" class="nav-link"><i class="fa fa-plus nav-icon"></i><p>Tambah Staff &amp; Mentor</p></a>
              </li>
              <li class="nav-item"><a href="{{ asset('admin/kategori_staff') }}" class="nav-link"><i class="fa fa-tags nav-icon"></i><p>Kategori Staff &amp; Mentor</p></a>
              </li>
            </ul>
          </li>
